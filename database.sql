...
CREATE TABLE `agenda` (
  ...
  KEY `fk_event_idx` (`id`),
  CONSTRAINT `fk_event` FOREIGN KEY (`id`) REFERENCES `event` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `agenda` VALUES (1,'jour1','vert'),(2,'jour2','rouge');
...
INSERT INTO `event` VALUES (1,'rdv',1,'2020-02-07 12:35:52','2020-02-07 12:35:52'),(2,'reunion',2,'2020-02-07 12:35:52','2020-02-07 12:35:52');
...
INSERT INTO `people` VALUES (1,'josette'),(2,'michel');
...
-- Dump completed on 2020-02-07 15:04:40
